...
public class ListExportOption extends RaplaGUIComponent implements OptionPanel {
    ...
    JComboBox separator = new JComboBox( new String[] {SEPARATOR_SEMICOLON, SEPARATOR_COMMA, SEPARATOR_COMMA, SEPARATOR_PIPE});
    ...
    public ListExportOption(RaplaContext sm) throws RaplaException {
            super( sm);
    ...
    public void create() throws RaplaException {
        ...
        //  columns = 2, rows = 5
        panel.setLayout( new TableLayout(new double[][] {{pre,5 ,pre,5}, {pre,5, pre,5, pre,5, pre,5, pre,5 ,fill}}));
